% Creation      : 16-Mar-2017 21:01
% Last Revision : 16-Mar-2017 21:01
% Author        : Xinyu Wang {xinke_wang.ss@qq.com}
% File Type     : matlab
%
% Learning how to use the TreeBagger() function in MATLAB
% TreeBagger() implements the 'random forest' algorithm, this demo shows how
% to use TreeBagger() to training an easy classification machine learning
% model and predict new samples.
% -------------------------------------------------------------------------
% Xinyu Wang @ 2017
